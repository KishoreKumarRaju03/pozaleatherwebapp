...
import '../../../../style/subComponentsStyle/microBagsHomeStyle.css'; 
...
const MicroBagsHome = () => {
    ...
    return (
        <div className="microBags-home-container">
            <div className="microBags-home-content">
                {microBags.map((bag, index) => (
                    <div key={index} className="microBag-item">
                        <img 
                            src={bag.image} 
                            alt={bag.name}
                            className="microBag-image"
                        />
                        <h3 className="microBag-name">{bag.name}</h3>
                        <p className="microBag-description">{bag.description}</p>
                    </div>
                ))}
            </div>
        </div>
