...
import '../../../../style/subComponentsStyle/beltsHomeStyle.css'; 
...
const BeltsHome = () => {
    ...
    return(
        <>
            <div className="belts-home-container">
                <div className="belts-home-content">
                    {Belts.map((bag, index) => (
                        <div key={index} className="belts-item">
                            <img 
                                src={bag.image} 
                                alt={bag.name}
                                className="belts-image"
                            />
                            <h3 className="belts-name">{bag.name}</h3>
                            <p className="belts-description">{bag.description}</p>
                        </div>
                    ))}
                </div>
            </div>
